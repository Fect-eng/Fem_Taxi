...
import pe.com.android.femtaxi.databinding.ActivityUploadDniBinding;
import pe.com.android.femtaxi.helpers.Constants;
import pe.com.android.femtaxi.models.registroDriver1;
import pe.com.android.femtaxi.utils.FileUtils;

public class UploadDNIActivity extends AppCompatActivity {
    String TAG = UploadDNIActivity.class.getSimpleName();
    private ActivityUploadDniBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityUploadDniBinding.inflate(getLayoutInflater());
        ...
        binding.btnNext.setOnClickListener(view -> {
            if (mTempUri != null) {
                ...
                Toast.makeText(UploadDNIActivity.this, "Debe seleccionar una foto antes de continuar " , Toast.LENGTH_SHORT).show();
            }
        });

        binding.btnHelp.setOnClickListener(view -> {
            AlertDialog.Builder alerta = new AlertDialog.Builder(UploadDNIActivity.this);
        ...
        PermissionX.init(this)
                ...
                .request((allGranted, grantedList, deniedList) -> {
                    if (allGranted) {
                        ...
                        mTempUri = FileUtils.pickImageCamera(UploadDNIActivity.this,
                                prefix,
                                codeRequest);
                    }
                });
    ...
    private void sendImage() {
        ...
        filepath.putFile(mTempUri)
                .addOnSuccessListener((taskSnapshot) -> {
                    Toast.makeText(UploadDNIActivity.this, "Se subio Correctamente la foto", Toast.LENGTH_SHORT).show();
                    moveToNext();
    ...
    private void moveToNext() {
        Intent intent = new Intent(UploadDNIActivity.this, UploadDriverActivity.class);
