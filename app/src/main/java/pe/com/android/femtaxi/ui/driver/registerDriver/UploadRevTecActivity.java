...
import pe.com.android.femtaxi.databinding.ActivityUploadRevTecBinding;
import pe.com.android.femtaxi.helpers.Constants;
import pe.com.android.femtaxi.models.registroDriver1;
import pe.com.android.femtaxi.utils.FileUtils;

public class UploadRevTecActivity extends AppCompatActivity {
    String TAG = UploadRevTecActivity.class.getSimpleName();
    private ActivityUploadRevTecBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityUploadRevTecBinding.inflate(getLayoutInflater());
        ...
        binding.btnNext.setOnClickListener(view -> {
            if (mTempUri != null) {
                ...
                Toast.makeText(UploadRevTecActivity.this, "Debe seleccionar una foto antes de continuar ", Toast.LENGTH_SHORT).show();
            }
        });

        binding.btnHelp.setOnClickListener(view -> {
            AlertDialog.Builder alerta = new AlertDialog.Builder(UploadRevTecActivity.this);
        ...
        PermissionX.init(this)
                ...
                .request((allGranted, grantedList, deniedList) -> {
                    if (allGranted) {
                        ...
                        mTempUri = FileUtils.pickImageCamera(UploadRevTecActivity.this,
                                prefix,
                                codeRequest);
                    }
                });
    ...
    private void sendImage() {
        ...
        filepath.putFile(mTempUri)
                .addOnSuccessListener((taskSnapshot) -> {
                    Toast.makeText(UploadRevTecActivity.this, "Se subio Correctamente la foto", Toast.LENGTH_SHORT).show();
                    moveToNext();
    ...
    private void moveToNext() {
        Intent intent = new Intent(UploadRevTecActivity.this, UploadSoatActivity.class);
