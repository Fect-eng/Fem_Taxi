...
public class PenalesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_penales);
        ...
        activityPolicia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PenalesActivity.this, DNIActivity.class);
        ...
        btnconsulta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alerta = new AlertDialog.Builder(PenalesActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == GALLERY_INTENT && resultCode == RESULT_OK) {
            ...
            StorageReference filePath = mStorage.child("Penales").child(uri.getLastPathSegment());    //getLastPathSegment     getEncodedPath
            ...
            filePath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Glide.with(PenalesActivity.this)
                            .load(downloadUrl)
                            .fitCenter()
                            .centerCrop()
                            .into(mImageView);
                    ...
                    Toast.makeText(PenalesActivity.this, "Se subio Correctamente la Foto", Toast.LENGTH_SHORT).show();
                }
            });
        }
