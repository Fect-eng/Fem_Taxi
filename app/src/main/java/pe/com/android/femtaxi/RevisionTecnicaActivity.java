...
public class RevisionTecnicaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_revision_tecnica);
        ...
        activityPolicia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RevisionTecnicaActivity.this, SetareActivity.class);
                startActivity(intent);
                RevisionTecnicaActivity.this.finish();
            }
        });
        ...
        btnconsulta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alerta = new AlertDialog.Builder(RevisionTecnicaActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == GALLERY_INTENT && resultCode == RESULT_OK) {
            ...
            StorageReference filePath = mStorage.child("Revision_Tecnica").child(uri.getLastPathSegment());    //getLastPathSegment     getEncodedPath
            ...
            filePath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Glide.with(RevisionTecnicaActivity.this)
                            .load(downloadUrl)
                            .fitCenter()
                            .centerCrop()
                            .into(mImageView);
                    ...
                    Toast.makeText(RevisionTecnicaActivity.this, "Se subio Correctamente la Foto", Toast.LENGTH_SHORT).show();
                }
            });
        }
