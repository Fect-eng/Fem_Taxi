...
import pe.com.android.femtaxi.databinding.ActivityUploadSetareBinding;
...
public class UploadSetareActivity extends AppCompatActivity {
    String TAG = UploadSetareActivity.class.getSimpleName();
    private ActivityUploadSetareBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityUploadSetareBinding.inflate(getLayoutInflater());
        ...
        binding.btnHelp.setOnClickListener(view -> {
            AlertDialog.Builder alerta = new AlertDialog.Builder(UploadSetareActivity.this);
        ...
        PermissionX.init(this)
                ...
                .request((allGranted, grantedList, deniedList) -> {
                    if (allGranted) {
                        ...
                        mTempUri = FileUtils.pickImageCamera(UploadSetareActivity.this,
                                prefix,
                                codeRequest);
                    }
                });
    ...
    private void sendImage() {
        ...
        filepath.putFile(mTempUri)
                .addOnSuccessListener((taskSnapshot) -> {
                    Toast.makeText(UploadSetareActivity.this, "Se subio Correctamente la foto", Toast.LENGTH_SHORT).show();
                    moveToNext();
    ...
    private void moveToNext() {
        Intent intent = new Intent(UploadSetareActivity.this, UploadRevTecActivity.class);
