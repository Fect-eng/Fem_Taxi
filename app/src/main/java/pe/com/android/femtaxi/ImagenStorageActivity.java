...
public class ImagenStorageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_imagen_storage);
        ...
        activityPolicia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ImagenStorageActivity.this, PenalesActivity.class);
                startActivity(intent);
                ImagenStorageActivity.this.finish();
            }
        });
        ...
        btnconsulta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alerta = new AlertDialog.Builder(ImagenStorageActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == GALLERY_INTENT && resultCode == RESULT_OK) {
            ...
            StorageReference filePath = mStorage.child("Policiales").child(uri.getLastPathSegment());    //getLastPathSegment     getEncodedPath
            ...
            filePath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                   mProgressDialog.dismiss();
                    ...
                    Glide.with(ImagenStorageActivity.this)
                            .load(downloadUrl)
                            .fitCenter()
                            .centerCrop()
                            .into(mImageView);
                    ...
                    Toast.makeText(ImagenStorageActivity.this, "Se subio Correctamente la Foto", Toast.LENGTH_SHORT).show();
                }
            });
        }
